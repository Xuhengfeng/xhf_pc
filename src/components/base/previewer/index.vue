    ...
    <div class="pswp__scroll-wrap">
      ...
      <div class="pswp__ui pswp__ui--hidden">
        <div class="pswp__top-bar">
          ...
          <button class="pswp__button pswp__button--download" title="download"><a ref="downloadEle" class="el-icon-download"></a></button>
...
export default {
  ...
  methods: {
    ...
    doInit (index) {
      ...
      let options = {
        ...
        isClickableElement: function (el) {
          return /^pswp__button--download$/.test(el.className)
        },
        getThumbBoundsFn (index) {
          // find thumbnail element
          let thumbnail = document.querySelectorAll('.image-item')[index]
          // get window scroll Y
    ...
    setDownload (index) {
      this.$refs.downloadEle.href = this.imgs[index]['download']
      this.$refs.downloadEle.download = this.imgs[index]['name']
    }
  }
}
</script>
...
.pswp__button--download .el-icon-download {
  text-decoration: none;
  font-size: 21px;
  font-weight: bold;
  color: #ddd;
}
.pswp__button--download .el-icon-download:hover {
  color: #fff;
}
.pswp__bg {
